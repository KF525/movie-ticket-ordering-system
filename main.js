...
function $s_Lorg_movieticketordering_Main__main__AT__V(args) {
  $m_Lorg_movieticketordering_Main$().main__AT__V(args)
}
/** @constructor */
function $c_Lorg_movieticketordering_Main$() {
  /*<skip>*/
}
$c_Lorg_movieticketordering_Main$.prototype = new $h_O();
$c_Lorg_movieticketordering_Main$.prototype.constructor = $c_Lorg_movieticketordering_Main$;
/** @constructor */
function $h_Lorg_movieticketordering_Main$() {
  /*<skip>*/
}
$h_Lorg_movieticketordering_Main$.prototype = $c_Lorg_movieticketordering_Main$.prototype;
$c_Lorg_movieticketordering_Main$.prototype.main__AT__V = (function(args) {
  $m_Lorg_movieticketordering_Main$package$().appendPar__Lorg_scalajs_dom_Node__T__V(document.body, "Hello World")
});
var $d_Lorg_movieticketordering_Main$ = new $TypeData().initClass({
  Lorg_movieticketordering_Main$: 0
}, false, "org.movieticketordering.Main$", {
  Lorg_movieticketordering_Main$: 1,
  O: 1
});
$c_Lorg_movieticketordering_Main$.prototype.$classData = $d_Lorg_movieticketordering_Main$;
var $n_Lorg_movieticketordering_Main$;
function $m_Lorg_movieticketordering_Main$() {
  if ((!$n_Lorg_movieticketordering_Main$)) {
    $n_Lorg_movieticketordering_Main$ = new $c_Lorg_movieticketordering_Main$()
  };
  return $n_Lorg_movieticketordering_Main$
}
/** @constructor */
function $c_Lorg_movieticketordering_Main$package$() {
  /*<skip>*/
}
$c_Lorg_movieticketordering_Main$package$.prototype = new $h_O();
$c_Lorg_movieticketordering_Main$package$.prototype.constructor = $c_Lorg_movieticketordering_Main$package$;
/** @constructor */
function $h_Lorg_movieticketordering_Main$package$() {
  /*<skip>*/
}
$h_Lorg_movieticketordering_Main$package$.prototype = $c_Lorg_movieticketordering_Main$package$.prototype;
$c_Lorg_movieticketordering_Main$package$.prototype.appendPar__Lorg_scalajs_dom_Node__T__V = (function(targetNode, text) {
  var parNode = document.createElement("p");
  parNode.textContent = text;
  targetNode.appendChild(parNode)
});
var $d_Lorg_movieticketordering_Main$package$ = new $TypeData().initClass({
  Lorg_movieticketordering_Main$package$: 0
}, false, "org.movieticketordering.Main$package$", {
  Lorg_movieticketordering_Main$package$: 1,
  O: 1
});
$c_Lorg_movieticketordering_Main$package$.prototype.$classData = $d_Lorg_movieticketordering_Main$package$;
var $n_Lorg_movieticketordering_Main$package$;
function $m_Lorg_movieticketordering_Main$package$() {
  if ((!$n_Lorg_movieticketordering_Main$package$)) {
    $n_Lorg_movieticketordering_Main$package$ = new $c_Lorg_movieticketordering_Main$package$()
  };
  return $n_Lorg_movieticketordering_Main$package$
}
/** @constructor */
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Lorg_movieticketordering_Main__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
